...
import { deleteCalendar, getMyCalendar, modifyCalendar, registerCalendar, viewCalendar } from "../controllers/calendarController";
...
// 개인 캘린더 조회
router.get('/mine', ensureAuthorization, getMyCalendar);
